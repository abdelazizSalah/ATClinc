...
namespace DBapplication
{
    public class DBManager
    {
        ...
        static string DB_Connection_String = @"Data Source=AbdelazizPC;Initial Catalog=ClincAR;Integrated Security=True";
        ...
        public DataTable GetPhotos(string command)
        {
            try
            {
                SqlCommand comm = new SqlCommand(command, myConnection);
